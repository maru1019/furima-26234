...
ActiveRecord::Schema[7.0].define(version: 2024_05_29_053028) do
  ...
  create_table "items", charset: "utf8", force: :cascade do |t|
    ...
    t.integer "item_shopping_fee_status_id", null: false
  ...
  create_table "shipments", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["purchases_id"], name: "index_shipments_on_purchases_id"
  end
